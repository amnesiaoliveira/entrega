...
Consulte [PRODUCAO.md](PRODUCAO.md) para usar instalador.ps1, importar o banco existente, configurar servico, backup diario, restauracao e HTTPS. Versao: **1.0.4**; veja [CHANGELOG.md](CHANGELOG.md).
